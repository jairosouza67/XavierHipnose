...
const ContactSection = () => {
    return (
        <section id="contato" className="py-32 bg-white dark:bg-slate-900 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-20">
                    <AnimatedSection direction="left">
                        <div className="space-y-12">
                            <div>
                                ...
                                <p className="text-slate-500 dark:text-slate-300 mt-8 text-lg">
                                ...
                                <p className="text-primary dark:text-white font-semibold text-lg mt-8 italic">
                                    ...
                                    <div key={i} className="flex gap-6 items-center group">
                                        {item.link ? (
                                            <a href={item.link} target="_blank" rel="noopener noreferrer" className="flex gap-6 items-center w-full">
                                                <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-2xl flex items-center justify-center text-secondary group-hover:bg-primary dark:group-hover:bg-slate-700 group-hover:text-secondary transition-all duration-300">
                                                    <item.icon size={28} />
                                                </div>
                                                <div>
                            ...
                            <div className="h-64 rounded-[2.5rem] overflow-hidden shadow-xl border-8 border-slate-50 dark:border-slate-800">
                                <iframe
                                    title="Mapa"
                    ...
                    <AnimatedSection direction="right" delay={0.2}>
                        <div className="bg-slate-50 dark:bg-slate-800 p-10 md:p-14 rounded-[3.5rem] border border-slate-100 dark:border-slate-700 shadow-sm">
                            <ContactForm />
                        </div>
                    </AnimatedSection>
                </div>
