...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-warm-white dark:bg-slate-900 pb-20 lg:pb-0 transition-colors duration-300">
            ...
            <a
                ...
                className="fixed bottom-20 lg:bottom-6 right-4 lg:right-6 z-40 flex bg-[#25D366] text-white p-3.5 lg:p-4 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
            >
